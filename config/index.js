export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxed59d989d687fc35",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "c72dca877fecbe13e08f96444b03c42a",
  ...
  USERS: [
    {
      ...
      id: "o1wxd5nse9POiIMPye23FVpH3y_g",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "LNX8F9jJcSpy3jO-n2dV1CDpilSVqqY4KLyEI7B7xF8",
      // 所在省份
      province: "山东",
      // 所在城市
      city: "潍坊",
      ...
      festivals: [
        ...
        {"type": "生日", "name": "李四", "year": "2001", "date": "03-24"},
  ...
  CALLBACK_USERS: [
    {
      ...
      id: "o1wxd5rxzoh4ZV1PG0tgnyDmNITg",
    },
    // 你可以不断按格式往下增加
    // ...
  ],
